...
def kmeans(points, k, cutoff):
    # Randomly sample <strong class="highlight">k</strong> Points from the points list, build Clusters around them
...
# -- Main function
def main(args):
    num_points, n, <strong class="highlight">k</strong>, cutoff, lower, upper = 10, 2, 3, 0.5, -200, 200
    ...
    clusters = kmeans(points, <strong class="highlight">k</strong>, cutoff)
    # Print the results
    print "\nPOINTS:"
